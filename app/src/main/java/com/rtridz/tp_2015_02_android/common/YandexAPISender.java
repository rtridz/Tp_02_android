...
public class YandexAPISender {
    ...
    public static String translate(String text, String fromLang, String toLang) throws UnsupportedEncodingException {
    ...
    public static AutoTranslateResult autoTranslate(String text, String toLang) throws UnsupportedEncodingException {
        if (text.length() > 10_000) {
            return null;
        }
        StringBuilder url = new StringBuilder(YA_TR_URL);
